                        ...
                        <div>
                           <div className="bg-seventh-darkblue p-3 rounded-r-lg rounded-bl-lg mb-2 animate-show">
                              <p className="text-sm text-white">
                                 Приветствуем испытателей нашего тест-квеста! Данный квест создан для того, чтобы дать нашим участникам представление о городских квестах вообще и показать, как происходит процесс стандартного квеста.</p>
                           </div>
                           <div className="bg-seventh-darkblue p-3 rounded-r-lg rounded-bl-lg my-4 animate-show-2">
                              <p className="text-sm text-white">
                                 Все ваши приключения в дальнейшем будут происходить на улицах нашего славного города: наш бот так же, как и сейчас, будет присылать вам задания; вам же нужно будет найти загаданное место, прийти туда и ответить на вопрос, как-то с этим местом связанный. После правильного ответа бот даст вам новое задание и вы сможете отправиться дальше.</p>
                           </div>
                           <div className="bg-seventh-darkblue p-3 rounded-r-lg rounded-bl-lg my-4 animate-show-3">
                              <p className="text-sm text-white">
                                 А сейчас, чтобы вы сами могли попробовать всё и разобраться, мы отправимся в маленький квест по... вашему дому! Напишите боту &quot;тест-квест вперёд&quot;, чтобы начать.</p>
                           </div>
                           <div className="bg-seventh-darkblue p-3 rounded-r-lg rounded-bl-lg my-4 animate-show-4">
                              <p className="text-sm text-white">
