                  ...
                  <div>
                     <div>
                        ...
                        <div className="mt-8 flex gap-x-4 sm:justify-center">
                           <a
                              href="#"
                              className="bg-fifth-red inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-sixth-gold hover:bg-indigo-700 md:mx-1 lg:mx-2 hover:ring-indigo-700"
                           >
                              Выбрать квест
