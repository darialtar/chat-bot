               ...
               <div className="mx-auto max-w-full sm:pb-36 sm: lg:pt-8">
                  ...
                  <div className="mb-6">
                     <div className="leading-10">
                        <div className="flex items-center justify-center">
                           <p className="text-center text-darkblue-300 font-bold bg-white/90">Готовность к приключениям загружается...                     </p>
                        ...
                        <h1 className="text-3xl text-center font-extrabold leading-10 bg-white/90 mx-2">
                           Что за квест вам предстоит пройти?
                        </h1>
                        </div>
                        <div className="flex items-center justify-center rounded-lg">
                        <h2 className="text-xl text-center font-bold leading-9 bg-white/90">
                           Давайте узнаем!
                        </h2>
                        </div>
                        </div>
                     ...
                     <div className="flex justify-center">
                        <p className="md:text-xs lg:text-sm pt-1 bg-white/80">цена для компании от 1 до 8 человек</p>
                     </div>
                  </div>
                  ...
                  <div>
                     <section className="mb-20">
                        <div className=" bg-white/90 md:max-w-xl lg:max-w-3xl mx-auto">
                           <div className="flex justify-center">
                           <h3 className="flex justify-center text-3xl font-bold mb-6 ">Отзывы</h3>
                           </div>
                           <div>
                           <p className="flex justify-center mb-6 pb-2 md:mb-12 md:pb-0">
                              Краткий обзор трех отзывов от наших клиентов.
                           </p>
                           </div>
                        </div>

                        <div className="grid bg-white/90 md:grid-cols-3 gap-6 lg:gap-12 text-center">
